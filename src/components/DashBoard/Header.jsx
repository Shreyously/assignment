...
const Header = () => {
  ...
  const [activeButton, setActiveButton] = useState(); // default repo
  ...
  // Function to get the appropriate button class based on whether it's active or not
  const getButtonClass = (buttonName) => {
    return activeButton === buttonName
      ? 'bg-blue-500 text-white' // Active 
      : 'text-[#414651] hover:bg-[#FAFAFA]'; // Inactive
  };
      ...
      {menu && (
        <>
          <div className="bg-white h-fit px-4 pb-4">
            ...
            <div className="mt-4">
              <button
                className={`w-full font-medium py-2 px-3 rounded-md shadow-[inset_0px_0px_0px_2px_rgba(59,_130,_246,_0.5)] flex flex-row items-center justify-start gap-2 ${getButtonClass('repositories')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('aiCodeReview')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('cloudSecurity')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('howToUse')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('settings')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('support')}`}
              ...
              <button
                className={`w-full font-medium py-2 px-3 rounded-md flex flex-row items-center justify-start gap-2 ${getButtonClass('logout')}`}
