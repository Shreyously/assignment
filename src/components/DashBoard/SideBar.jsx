...
const SideBar = () => {
  ...
  // Handle button click to change active button and color
    ...
    <div className="hidden h-screen border-r border-[#E9EAEB] w-[16%] py-4 px-3 lg:flex flex-col justify-between">
      <div>
        ...
        <select className="w-full hover:bg-[#FAFAFA] mt-4 p-2 rounded-md border border-[#D5D7DA] focus:outline-none">
          <option value="UtkarshDhairyaPanwar">{truncateName("UtkarshDhairyaPanwar")}</option>
          <option value="Shrey">Shrey</option>
        </select>
        <div className="mt-4">
          <button
            className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('repositories')}`}
          ...
          <button
            className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('aiCodeReview')}`}
          ...
          <button
            className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('cloudSecurity')}`}
          ...
          <button
            className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('howToUse')}`}
          ...
          <button className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('settings')}`}
      ...
      <div>
      <button
          className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('support')}`}
        ...
        <button
          className={`w-full font-medium py-2 px-3 rounded-lg flex flex-row items-center justify-start gap-2 ${getButtonClass('logout')}`}
