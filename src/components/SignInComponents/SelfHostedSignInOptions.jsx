    ...
    <div className="pt-5 pb-[136px] px-3 flex flex-col items-center justify-center gap-2">
      {buttonItems.map((eachButtonItems, index) => (
        <button
          ...
          className="w-[100%] hover:bg-[#FAFAFA] disabled:bg-gray-50 disabled:cursor-not-allowed md:w-[60%] py-3 font-semibold text-[#171717] rounded-lg border border-[#D8DAE5] flex flex-row items-center justify-center gap-2"
